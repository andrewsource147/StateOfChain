...
function (_DappBrowser) {
  ...
  function ModernMetamaskBrowser() {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(ModernMetamaskBrowser).call(this));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "getWalletType", function () {
      return "metamask";
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "getNetworkId", function () {
      return new Promise(function (resolve, reject) {
        _this2.web3.eth.net.getId(function (error, result) {
          if (error || !result) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "getCoinbase", function () {
      var _this = _assertThisInitialized(_assertThisInitialized(_this2)); //console.log(_this)
    ...
    _this2.web3 = new web3__WEBPACK_IMPORTED_MODULE_0___default.a(web3__WEBPACK_IMPORTED_MODULE_0___default.a.givenProvider);
    return _this2;
  }
...
//# sourceMappingURL=_app.js.e6288678668ff0fbaa25.hot-update.js.map