...
const input = {
  "StackVotes.sol": fs.readFileSync(contractPath + 'StackVotes.sol', 'utf8'),  
};
...
async function main() {
  ...
  let StackVotesContract;
  [StackVotesAddress, StackVotesContract] = await deployContract(output, "StackVotes.sol:StackVotes", []);

  console.log("StackVotes address", StackVotesAddress);
